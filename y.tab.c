...
{
      14,     0,    -1,    15,    -1,    -1,    16,    -1,    16,    15,
      -1,     5,    17,    11,    -1,     1,    11,    -1,    18,    -1,
      18,    10,    17,    -1,    19,    -1,    20,    -1,     6,     3,
       8,    -1,     7,     4,     9,    -1
};
...
{
  "$end", "error", "$undefined", "T_BLOCK_NUMBER", "T_DEGREE_NUMBER",
  "T_ROBOT_PLEASE", "T_MOVE", "T_TURN", "T_BLOCKS", "T_DEGREES", "T_THEN",
  "T_NEWLINE", "T_OTHER", "$accept", "program_code", "statements_code",
  "statement_code", "actions_code", "action_code", "move_code",
  "turn_code", 0
};
#endif
...
{
      -3,     1,    -4,     1,     6,     2,    13,     2,    15,     7,
       8,    16,    17,    21,    18,    14,    19,     0,    20
};

static const yytype_int8 yycheck[] =
{
       0,     1,     0,     1,    11,     5,     0,     5,     3,     6,
       7,     4,    11,    18,    10,     5,     8,    -1,     9
};
...
{
       0,     1,     5,    14,    15,    16,    11,     6,     7,    17,
      18,    19,    20,     0,    15,     3,     4,    11,    10,     8,
       9,    17
};
